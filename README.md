...
A simple and interactive weather app that allows users to fetch and display real-time weather data for any city in the world. Built using **HTML**, **CSS**, and **JavaScript**, the app utilizes the **OpenWeatherMap API** to provide weather updates, including temperature, humidity, wind speed, and weather conditions.
...
## Screenshots
[!Screenshot1](<images/Screenshot 2024-09-29 203204.png>),[!screenshort2](<images/Screenshot 2024-09-29 211615.png>),[!screenshort3](<images/Screenshot 2024-09-29 211728.png>)
